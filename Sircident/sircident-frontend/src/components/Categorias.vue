          ...
          <template v-slot:top>
            <v-toolbar flat color="white">
              ...
              <v-dialog v-model="modalCategoria" persistent max-width="700px">
                ...
                <v-card>
                  <v-card-title class="teal lighten-1" primary-titles>
        ...
        me.$http
          ...
          .catch(function(error) {
            ...
            if (error.response.status == 409) {
              ...
              me.errorsNombre = ["Nombre De La Categoria Existente"];
            } else {
          ...
          me.$http
            ...
            .catch(function(error) {
              if(error.response.status  == 510){
                Toast.fire({
                icon: "error",
                title: "No se puede eliminar esta categoria, tiene registros"
              });
              } 
              me.loader = false;
            });
        ...
        case "del":
          if (statusCode == 200) {
            try {
              ...
              me.$swal.fire("Eliminado", "Categoría Eliminada", "success");
            } catch (error) {
              console.log(error);
            }
          } else {
